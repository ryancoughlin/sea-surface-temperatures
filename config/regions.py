...
REGIONS: Dict[str, Region] = {
    ...
    #     "description": "Overview of Northeast US submarine canyons",
    #     "bounds": [
    ...
    #     "description": "Northern section of Northeast US submarine canyons",
    #     "bounds": [
    ...
    #     "description": "Southern section of Northeast US submarine canyons",
    #     "bounds": [
    #         [-77.0, 36.0],  # [west, south]
